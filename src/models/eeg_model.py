...
直接集成 model_backends/eeg_backend/brain_load 中的推理代码
"""
...
# 添加 brain_load 路径
_EEG_BACKEND_PATH = Path(__file__).parent.parent.parent / "model_backends" / "eeg_backend"
_BRAIN_LOAD_PATH = _EEG_BACKEND_PATH / "brain_load"
sys.path.insert(0, str(_BRAIN_LOAD_PATH))
